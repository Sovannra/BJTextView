...
public class BJUITextView: UITextView {
    ...
    private func commonInitializer() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(BJUITextView.handleTextViewTextDidChangeNotification(_:)), name: UITextView.textDidChangeNotification, object: self)
    }
    
    @objc internal func handleTextViewTextDidChangeNotification(_ notification: Notification) {
        
        guard let object = notification.object as? BJUITextView, object === self else {
